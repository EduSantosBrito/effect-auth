...
See `examples/minimal/README.md` for the integration shape: provide storage, bridge `effect-email` to `AuthEmail`, compose `AuthLive.dev`, then call the auth workflows.
